...
private:
    ...
    void setStick(const Vec2& state);

    nw4r::lyt::Pane* m_dpadPanes[DpadState_Count];
    nw4r::lyt::Pane* m_accelPanes[AccelState_Count];
    nw4r::lyt::Pane* m_triggerPanes[Trigger_Count][TriggerState_Count];
    ...
    TriggerState m_triggerStates[Trigger_Count];
    Vec2 m_stickState;
    u32 m_playerId;
